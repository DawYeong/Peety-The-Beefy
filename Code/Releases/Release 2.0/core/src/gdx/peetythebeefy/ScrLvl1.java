...
public class ScrLvl1 implements Screen, InputProcessor {
    ...
    public void render(float f) {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.P)) { //back button is behind the tiledmap
    ...
    public Body createBody(float x, float y, float width, float height, boolean isStatic) {
        ...
        pShape.setAsBox((float) width / 2 / 32, (float) height / 2 / 32);
    ...
    public void move() {
        float fhForce = 0; // horizontal force
